...
<div class="dest-card">
  ...
  <div class="dest-body">
    ...
    {hotel_line}
    <div class="btn-row">
      <a class="btn-aff btn-aff-dark" href="{r['url_sky']}" target="_blank" rel="noopener">{T['btn_sky']}</a>
      <a class="btn-aff" href="{r['url_book']}" target="_blank" rel="noopener">{T['btn_book']}</a>
    </div>
  </div>
</div>
"""
