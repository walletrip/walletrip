...
with st.sidebar:
    ...
    st.markdown(f'<div style="font-size:0.78rem;letter-spacing:0.06em;text-transform:uppercase;color:#6B6560;margin-top:0.8rem;margin-bottom:4px">{T["fav"]} <span style="font-weight:300;text-transform:none;letter-spacing:0">(optionnel)</span></div>', unsafe_allow_html=True)
    fav = st.text_input("fav_hidden", placeholder=T["fav_ph"], label_visibility="collapsed")
