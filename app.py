...
<style>
  ...
  div[data-testid="stMetricLabel"] { font-size: 0.78rem !important; color: var(--muted) !important; }
  ...
  div[data-testid="stVerticalBlockBorderWrapper"]:hover {
    ...
    box-shadow: 0 4px 20px rgba(124,154,126,0.1) !important;
  }
</style>
...
<div style="display:flex;align-items:center;gap:10px;margin-bottom:0.5rem">
  <svg width="32" height="32" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="14" width="36" height="26" rx="6" fill="#EEF3EE" stroke="#7C9A7E" stroke-width="1.8"/>
    <path d="M4 21h36" stroke="#7C9A7E" stroke-width="1.4" stroke-linecap="round"/>
    <path d="M4 14c0-3.3 2.7-6 6-6h20c3.3 0 6 2.7 6 6" stroke="#7C9A7E" stroke-width="1.8" fill="none" stroke-linecap="round"/>
    <rect x="28" y="25" width="14" height="9" rx="4.5" fill="#7C9A7E"/>
    <circle cx="35" cy="29.5" r="2" fill="#EEF3EE"/>
    <g transform="translate(30,8) rotate(-30)">
      <path d="M0 0 L8 3 L0 6 L1.5 3 Z" fill="#4A6B4C"/>
    </g>
  </svg>
...
<div class="logo-wrap">
  <svg class="logo-svg" width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(30,8) rotate(-30)">
      <path d="M0 0 L8 3 L0 6 L1.5 3 Z" fill="#4A6B4C"/>
      <path d="M1 1.5 L-3 3.5 L-2 3 Z" fill="#7C9A7E"/>
      <path d="M5 2.5 L3 5.5 L3.5 3 Z" fill="#7C9A7E"/>
    </g>
  </svg>
